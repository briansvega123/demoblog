...
$app->get('/post/POST_ID', function (Silex\Application $app)  { // Match the root route (/) and supply the application as argument
    
    return 'POST_ID; // Return it to so it gets displayed by the browser
});

$app->get('/archive/year/Month', function (Silex\Application $app)  { // Match the root route (/) and supply the application as argument
    
    return 'test'; // Return it to so it gets displayed by the browser
});
